            ...
            <table class="table" style="width: 75%">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><img src="../img/AboutUs2.jpg" alt="Diamante2" style="width:50%" class="rounded float-end" alt="..."></td>
                        <td><img src="../img/AboutUs3.jpg" alt="Diamante3" style="width:50%" class="rounded float-end" alt="..."></td>
                        </tr>
                </tbody>
            </table>
        </center>
